...
const Checkout: React.FC = () => {
  ...
  const handleConfirmOrder = async () => {
    ...
    try {
      ...
      // Nếu là chuyển khoản ngân hàng, chuyển sang trang thanh toán
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-5 rounded-lg shadow border border-orange-200">
            ...
            <div className="space-y-2 text-sm">
              ...
              <label className="flex items-center gap-2 text-black">
                ...
                />
                <span className="opacity-50">Thanh toán bằng thẻ tín dụng</span>
              </label>
        ...
        <div className="bg-white p-5 rounded-lg shadow space-y-4 border border-orange-200">
            ...
            {cart.map((item) => (
              <div key={item.book_id} className="flex justify-between text-sm">
                <div>
                  ...
                  <p className="text-black">
                    SL: {item.quantity} x {item.price.toLocaleString("vi-VN")} VND
                  </p>
                </div>
          ...
          <div className="flex justify-between text-base font-bold mt-2 text-black">
            <span>Tổng cộng</span>
            <span className="text-orange-600">{getTotalPrice().toLocaleString("vi-VN")} VND</span>
          </div>
